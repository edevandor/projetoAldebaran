"""Testes das conversões compartilhadas pelos parsers do ERP legado."""


from ingestion.rel_comum import parse_br_num as _parse_br_num
from ingestion.rel_comum import parse_data_br as _parse_data_br
...
class TestParseBrNum:
    ...
    def test_valor_malformado_nao_e_inventado_como_zero(self):
        assert _parse_br_num("INVALIDO") is None
...
# de arquivos .rel de exemplo, mas nao ha prioridade atual.
